...
<a href="internshiplogout.php" class="list-group-item" >Logout</a>
		  ...
		  <div class="col-xs-12 col-sm-9">
			<div class="card">
			  ...
			  <div class="card-body">			  
<form class="form-horizontal" role="form" action="showmydailylog.php" method="post">
    <div class="row">
      ...
      <div class="col-sm-5">
          <select name="stdate" id="inputDate" class="form-select" required="required" />
				<option value=""> -- Select Date-- </option><option value="01-09-2022">01-09-2022</option><option value="02-09-2022">02-09-2022</option><option value="03-09-2022">03-09-2022</option><option value="05-09-2022">05-09-2022</option><option value="06-09-2022">06-09-2022</option><option value="07-09-2022">07-09-2022</option><option value="08-09-2022">08-09-2022</option><option value="09-09-2022">09-09-2022</option><option value="10-09-2022">10-09-2022</option><option value="12-09-2022">12-09-2022</option><option value="13-09-2022">13-09-2022</option><option value="14-09-2022">14-09-2022</option><option value="15-09-2022">15-09-2022</option><option value="16-09-2022">16-09-2022</option><option value="17-09-2022">17-09-2022</option><option value="20-09-2022">20-09-2022</option><option value="23-09-2022">23-09-2022</option>		  
			</select>			
      </div>
      <div class="col-sm-4">&nbsp;
      </div>
	...
	<br />		
        ...
        <div class="col-sm-5 text-right">
          <input type="hidden" name="todo" value="showmylog" />
          <button type="submit" class="btn btn-secondary">Show My Log</button>
        </div>
        ...
        <?php
              ...
              $obj = new Login();
              $arr = $obj->readdailylog($_SESSION["user"],$_POST["stdate"]);
              echo "<table class='table table-bordered'><tr><th>".$_SESSION["user"]."</th><th>"."   "."</th></tr>";
