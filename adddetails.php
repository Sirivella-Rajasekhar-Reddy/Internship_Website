...
if(!empty($_POST["id"]) && !empty($_POST["name"]) && !empty($_POST["fname"]) && !empty($_POST["gender"]) && !empty($_POST["num"]) && !empty($_POST["email"]) && !empty($_POST["website"])){
    ...
    $obj=new Login();
    $x=$obj->adddetails($_POST["id"],$_POST["name"],$_POST["fname"],$_POST["gender"],$_POST["num"],$_POST["email"],$_POST["website"]);
    if($x==1){
        $succ="Your details add successfully";
...
<form class="form-horizontal" role="form" action="adddetails.php" method="post" enctype="multipart/form-data">


    <div class="row">
      <label for="inputHtno" class="col-sm-3 control-label">Intern ID*</label>
      <div class="col-sm-5">
      <input class="form-control" type="text" name="id" placeholder="Enter Id" required="required" />
    </div>
      <div class="col-sm-4">&nbsp;
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-5">
      <input class="form-control" type="text" name="fname" placeholder="Enter Your Father Full Name" required="required" />
    </div>
      <div class="col-sm-4">&nbsp;
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-5">
          <select name="gender" id="inputDate" class="form-select" required="required" />
    ...
    <div class="row">
      ...
      <div class="col-sm-5">
      <input class="form-control" type="text" name="num" placeholder="Enter Your Number" required="required" />
    </div>
      <div class="col-sm-4">&nbsp;
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-5">
      <input class="form-control" type="text" name="website" placeholder="Enter Your Website Link" required="required" />
    </div>
      <div class="col-sm-4">&nbsp;
      </div>
    </div>
    <div class="row">
    <div class="col-sm-5">
    <input type="submit" class="btn btn-secondary" name="add" value="Add Details">
    </div>
      </div>
    <div class="col-sm-4">&nbsp;
